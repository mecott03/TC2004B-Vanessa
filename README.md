...
**Nombre:** Vanessa Alejandra Mecott Maldonado
**Matrícula:** A01199445
...
- Email: a01199445@tec.mx
- GitHub: [@mecott03](https://github.com/mecott03)
...
```bash
git clone https://github.com/mecott03/TC2004B-Vanessa.git
cd TC2004B-Vanessa
```
